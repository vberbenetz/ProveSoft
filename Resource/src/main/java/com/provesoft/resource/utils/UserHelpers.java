...
public final class UserHelpers {
    ...
    /**
     * Method checks if user is of type SYSTEM_ADMIN
     * @param auth Authentication object
     * @return Boolean on whether user is a System_Admin
     */
    public static Boolean isSystemAdmin(Authentication auth) {
        ...
        for (GrantedAuthority ga : authorities) {
            ...
            if (authority.equals("ROLE_SYSTEM_ADMIN")) {
                return true;
            }
        }
